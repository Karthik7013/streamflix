...
import { Home, Compass, UserRound, Video, LogIn, Sparkles, LucideIcon } from "lucide-react";
...
function BottomNavbar({
  ...
  return (
    ...
    >
      <div className="dock-glow flex items-center gap-1 rounded-full bg-background/80 backdrop-blur-xl border border-border/50 px-1.5 py-1.5">
        {navItems.map((item) => {
